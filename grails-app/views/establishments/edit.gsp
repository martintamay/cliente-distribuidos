...
<body>
<a href="#edit-establishments" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="edit-establishments" class="content scaffold-edit" role="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <g:form method="post" >
                <g:hiddenField name="id" value="${establishmentsInstance?.id}" />
                <fieldset class="form">
