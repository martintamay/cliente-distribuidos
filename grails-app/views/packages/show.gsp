...
<div id="show-packages" class="content scaffold-show" role="main">
    ...
    <g:link class="btn btn-primary pull-right" action="create" id="${packagesInstance?.id}"><i class="fas fa-plus-square"></i></g:link>

    <table class="table">

        <tbody>
        <th>Nombre</th> <td>${packagesInstance?.name}</td>
        <tr> <th>Costo</th> <td>${packagesInstance?.cost}</td></tr>
