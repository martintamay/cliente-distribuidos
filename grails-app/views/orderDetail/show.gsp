...
<html>
    ...
    <body>
        ...
        <div id="show-orderDetail" class="content scaffold-show" role="main">
            ...
            <f:display bean="orderDetail" />
            <g:form resource="${this.orderDetail}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orderDetail}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
