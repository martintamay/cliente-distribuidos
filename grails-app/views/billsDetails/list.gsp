...
<head>
    ...
    <title>Lista de Facturas Detalles</title>
</head>
<body>
<a href="#list-billsDetails" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>

<div id="list-billsDetails" class="container padding-menu" role="main">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="btn-group">
                <g:link class="btn btn-primary" action="create">Nueva Factura Detalle</g:link>
            </div>
...
<script>
    $(document).ready(function(){
        $('#text').keyup(function(){
            $.ajax({
                url:"${createLink(controller: 'billsDetails', action: 'search')}",
                data:{
                    text:$('#text').val()
                },
