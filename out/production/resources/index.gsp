                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="slider-content_wrap">
                                <h1>EncarDelivery</h1>
                                <h5>Encuentra todo lo que quieras comer en un solo luegar.</h5>
                            </div>
                        </div>
                    </div>
                    <!--div class="row d-flex justify-content-center">
        ...
        <div class="row">
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
        <asset:image src="featured1.jpg" class="img-fluid" alt="#"/>
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
            <asset:image src="featured2.jpg" class="img-fluid" alt="#"/>
            ...
            <div class="col-md-4 featured-responsive">
                <div class="featured-place-wrap">
                    <a href="detail.html">
                <asset:image src="featured3.jpg" class="img-fluid" alt="#"/>
